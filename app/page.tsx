        ...
        <div className="container mx-auto px-6 lg:px-20 py-20 lg:py-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 gap-y-0 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-0 right-0 w-48 h-48 bg-blue-400 opacity-20 rounded-full filter blur-3xl"></div>
              <Image
                src={AboutusImage}
                alt="About Us"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="absolute -top-10 -left-10 w-36 h-36 bg-gradient-to-br from-blue-500 to-blue-300 rounded-full opacity-20 group-hover:opacity-30 transition duration-300 blur-2xl"></div>
              ...
              {/* Hover Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-green-500 opacity-0 group-hover:opacity-20 rounded-2xl transition duration-300"></div>
            </div>
          ))}
        </div>
      </div>
...
const TestimonialsSection = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-50 via-white to-blue-100 dark:from-gray-800 dark:to-gray-900 py-16">
      <div className="container mx-auto px-6 lg:px-20">
